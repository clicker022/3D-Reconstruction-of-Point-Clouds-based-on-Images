 ...
 * @Example
 * if p = 50%, z = 99%, n = 8
 * then M = log(0.001) / log(0.99609) = 1176.
...
/**
 * @name calc_fundamental_least_squares
...
int main(int argc, char *argv[]){
    ...
    std::ifstream in("./camera_and_epipolar_geometry/correspondences.txt");
    assert(in.is_open());
