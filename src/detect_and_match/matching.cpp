...
feature_set_matching (mve::ByteImage::Ptr image1, mve::ByteImage::Ptr image2)
{
     ...
     * lowe_ratio_threshold 要求最佳匹配距离和次最佳匹配距离之间的比率低于某个阈值
     * distance_threshold 不接受距离大于此值的匹配项
     */
    ...
    sfm::Matching::twoway_match(sift_matching_opts,
                                ...
                                &sift_matching);
    /*
     * 去除不一致的匹配对，匹配对feature1和feature2是一致的需要满足，
     * feature1的最近邻居是feature2，feature2的最近邻是feature1
     */
...
main (int argc, char** argv)
{
    ...
    try
    {
        ...
        image1 = mve::image::load_file(std::string(argv[1]));
        // 图像尺寸减半
