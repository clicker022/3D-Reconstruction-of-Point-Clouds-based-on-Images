...
math::Vec3d triangulation(math::Vec2d const & p1
    ...
    std::cout<<"P1 for first pose should be\n"
             <<"0.972222 0 0 0\n"
             <<"0 0.972222 0 0\n"
             <<"0 0 1 0\n";

    std::cout<<"P2: "<<std::endl<<P2<<std::endl;
    std::cout<<"P2 for first pose should be\n"
        ...
        , math::Vec3d & t)
{
    ...
    std::cout<<std::endl;
    std::cout<<"Result of 4 candidate camera poses is:"<<std::endl;
    for(int i=0; i<4; i++)
    {
        std::cout<<"R"<<i<<std::endl;
        std::cout<<poses[i].first;
